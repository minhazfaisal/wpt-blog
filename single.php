          ...
          <div class="navigation-top">
            <div class="d-sm-flex justify-content-between text-center">
              ...
              <ul class="social-icons">
                ...
                <li>
                  <a href="<?php echo esc_url(add_query_arg('u', get_permalink(), 'https://www.facebook.com/sharer/sharer.php')); ?>"
                    target="_blank" rel="noopener noreferrer"
                    aria-label="<?php echo esc_attr('Share "' . get_the_title() . '" on Facebook'); ?>"> <i
                      class="ti-facebook" aria-hidden="true"></i>
                  </a>
                </li>
                <li>
                  <a target="_blank"
                    href="http://twitter.com/intent/tweet?text=<?php the_title(); ?>&amp;url=<?php the_permalink(); ?>"><i
                      class="ti-twitter"></i></a>
                </li>
                <li>
                  <a href="https://www.instagram.com/yourusername/" target="_blank" rel="noopener noreferrer"
                    aria-label="Visit us on Instagram"> <i class="ti-instagram" aria-hidden="true"></i></a>
                </li>
                <li>
                  <a href="<?php echo esc_url(add_query_arg('url', get_permalink(), 'https://www.linkedin.com/sharing/share-offsite/')); ?>"
                    target="_blank" rel="noopener noreferrer"
                    aria-label="<?php echo esc_attr('Share "' . get_the_title() . '" on LinkedIn'); ?>"> <i
                      class="ti-linkedin" aria-hidden="true"></i></a>
                </li>
              </ul>
            </div>
          ...
          <div class="blog-author">
            <div class="media align-items-center">
              ...
              <div class="media-body">
                ...
                <a
                  href="<?php echo get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename'), get_the_author_meta('user_email'), get_the_author_meta('user_url')); ?>">
